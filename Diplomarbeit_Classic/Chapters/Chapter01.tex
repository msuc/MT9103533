...
Three generations of Mars rovers developed at NASA are shown in Figure~\ref{fig:fig_nasa}. The first Mars rover, Sojourner, which landed on Mars in 1997 as part of the Mars Pathfinder Project was completely operated from earth. The next generation of rovers, Spirit and Opportunity which landed 2004, already have an autonomous navigation system, enabling the robots to avoid hazardous situations without human intervention. The latest rover Curiosity is on its mission on Mars since August 2012 using autonomous navigation to explore mars on safe paths without the help of human rover drivers.
...
The robot PIONEER, an invention of Carnegie Melon University, was the first of its kind to be deployed to the remnants of the nuclear power station in Chernobyl in the Ukraine (1986) after the supergau. The robots mission was to evaluate the sarcophagus which was built to shield off radiation.
In 2011 another nuclear disaster at the Fukushima Daiichi nuclear plant in Japan, where intense levels of radiation have made it increasingly dangerous for human rescue workers to operate.
...
\begin{figure}[thpb]
    ...
    \subfloat
    {  \label{fig:fig_agv}
        \includegraphics[width=0.45\textwidth,height=0.3\textheight]{figures/fig_hobbit.png}
        %\caption{Dijkstra}
    }
    \subfloat
    {  \label{fig:fig_uav}
        \includegraphics[width=0.45\textwidth,height=0.3\textheight]{figures/fig_robox.png}
        %\caption{Dijkstra}
    }     
