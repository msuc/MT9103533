...
This local planning method utilizes different memory structures to avoid cylcing back to already visited regions of the map. 
To escape local minima it provides an escaping mechanism by randomly approaching unvisited areas.

The method proposed in this work differs from these works by analysing and using single solution based meta-heuristics strategies for local path planning only. 
