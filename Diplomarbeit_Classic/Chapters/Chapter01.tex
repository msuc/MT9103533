...
\begin{description}
\item[Self driving vehicles]\hfill \\
Self driving cars (see Figure~\ref{fig:fig_auto}) like Stanley \cite{stanley} which won the 2005 DARPA Challenge and the Google car \cite{guizzo2011google} are two examples which illustrates the enormous potential of autonomous vehicles.
...
\begin{figure}[thpb]
   ...
   \caption[Selfdriving car]{Self driving cars designed for different environments. On the left the winner of the 2005 DARPA challenge tackled wreckless driving through the Mojave desert and the right picture shows the new Google car designed for urban traffic.}
   \label{fig:fig_auto}
\end{figure}
