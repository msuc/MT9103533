...
The values of RND and PND are applied as input to tree and are processed by the branching rules of the tree. 

Improvements on the ND method appear in \cite{minguez2001global} which adds a global information to the evaluation process. 
