...
\fxnote{Explain 2-step approach - Experiments with artificial local maps and example planner, and experiments within a simulation and real planners. Explain the boxplot.}
\section{Experiments}
