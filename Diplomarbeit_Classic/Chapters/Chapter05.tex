...
\begin{figure}[thpb]
   ...
   %\captionsetup[subfigure]{labelformat=empty} 
    ...
    \caption[Experiment: VNS-ROL tabu lists]{These figures show the result of using the VNS-ROL algorithm in the logo environment.
...
Using the short term memory structure did have a small but not significant performance increase, although less outlieres and slightly smaller variance of the measurements is observable.  
