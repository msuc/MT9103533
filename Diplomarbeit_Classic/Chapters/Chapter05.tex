...
The Trajectory Roll-out planner variant of the ROS-navigation stack implementation was altered to use the VNS approach and compared to the unaltered version in all of the following results.
