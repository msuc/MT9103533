...
The planning system choosen for testing comes ready to use in the implementation of the navigation stack of the ROS framework, which was introduced and implemented by Marder-Eppstein (see \cite{DBLP:conf/icra/Marder-EppsteinBFGK10}).
...
\subsection{Results using the sample planner}
...
\subsection{Results using simulated environments}
This set of experiments are conducted using the simulation software for the artificial and office environment. 
All of these tests are performed on an Intel Core2 Quad CPU with 2.66GHz and 8 GB RAM.

\subsubsection{Simulated robot in artificial environment}
